...
const options = {
  ...
  /* Widget position! */
  verticalPosition: "16", // -> top (default) | center | bottom | "<number>" | "-<number>"
...
export const className = `
  font-family: "MesloLGS NF", "Iosevka",-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  color: white;
