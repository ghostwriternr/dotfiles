...
Prioritize clarity, stability, and accessibility before stylistic novelty.

**Interaction design:**
- Make the next step obvious with clear focal points and primary actions.
- Preserve spatial stability -- avoid unnecessary movement, resizing, or layout jumps.
- Create real hierarchy: size, weight, color, and spacing should communicate importance, not decoration.
- Design complete interaction states: default, hover, focus, active, disabled, loading, empty, error.
- Use progressive disclosure to manage complexity without hiding essential information.
- Give immediate local feedback for user actions; avoid full-page reloads or spinners when inline updates suffice.
- Treat accessibility as a default quality bar -- semantic HTML, sufficient contrast, keyboard navigation, focus management, and ARIA where needed.

**Visual direction:**
When doing design tasks, avoid "AI slop" -- bland, interchangeable layouts that feel auto-generated. Aim for interfaces that feel intentional, deliberate, and bold.

- **Typography:** Use expressive, purposeful fonts and avoid default stacks (Inter, Roboto, Arial, system). Choose type that reinforces the product's personality.
- **Color:** Choose a clear visual direction; define CSS variables; avoid purple-on-white defaults. No purple bias or dark mode bias.
- **Motion:** Use a few meaningful animations (page-load, staggered reveals) instead of generic micro-motions.
- **Background:** Don't rely on flat, single-color backgrounds; use gradients, shapes, or subtle patterns to build atmosphere.
- **Density:** Avoid drowning the page in whitespace. Content should feel comfortably dense, not sparse.
